# install apyroi library in command prompt
...
# Data Preprocessing
df = pd.read_csv('Market Basket.csv', header= None)
transactions = []
...
# Displaying the first results coming directly fro the output of the apriori function
#print(results)
